...
class VolleyImageListener implements ImageLoader.ImageListener {
    ...
    VolleyImageListener(Context context, WeakReference<ImageView> imageView, VinciImageLoader.ImageCache imageCache) {
    ...
    public void onResponse(ImageLoader.ImageContainer response, boolean isImmediate) {
        ...
        if ( null != byteBuffer ) {
            ...
            mImageView.get().setImageDrawable(mContext.getResources().getDrawable(mLoadingImage));
        }
    }
